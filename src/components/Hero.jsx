...
>
  Book a Slot
              ...
              <button onClick={() => window.open("https://calendly.com/turbooads/30min", "_blank")} className="border border-[#00FFD1] text-[#00FFD1] px-6 py-2 rounded-full hover:bg-[#00FFD1] hover:text-black">
                Request a Quote
              </button>
            </div>
          </div>
